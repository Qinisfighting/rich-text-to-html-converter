    ...
    return (
      <footer className="mt-52">
        ...
        <a href="https://www.yanqin.de" target="_blank">
          <p className="text-base text-center bg-neutral-400 w-fit h-fit text-white  mx-auto rounded-full py-0 px-4 drop-shadow-md hover:bg-neutral-500 transition duration-700 ease-in-out">2024 © QIN's code</p>
        </a>
      </footer>
    );
  }
